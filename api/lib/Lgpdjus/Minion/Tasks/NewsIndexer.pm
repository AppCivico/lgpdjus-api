package Lgpdjus::Minion::Tasks::NewsIndexer;
...
sub news_indexer {
    ...
    my $response = $ua->get($news->{hyperlink}, {'User-Agent' => 'Indexador Feed RSS itsrio.org'})->result;
